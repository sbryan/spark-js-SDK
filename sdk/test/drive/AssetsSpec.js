describe('Assets', function () {
    ...
    var Assets, Client, Members, mockedAuthorizedRequest, mockedGuestAuthorizedRequest, mockedAccessTokenObj, mockedAccessToken,
        mockedAccessTokenIsValid,
    ...
    before(function () {
        ...
        mockedAccessToken = sinon.stub(Client, 'getAccessTokenObject').returns({spark_member_id: mockedAccessTokenObj.spark_member_id});
    ...
    it('should get a user\'s assets successfully', function () {
        ...
        var mockGetLoggedInMemberId = sinon.stub(Members, 'getLoggedInMemberId').returns(Promise.resolve(mockedAccessTokenObj.spark_member_id));
        ...
        return Assets.getMyAssets().then(function (response) {
            ...
            mockGetLoggedInMemberId.restore();
        });
    ...
    it('should be able to create asset thumbnails', function () {
        var assetId = 123131,
            assetThumbnailData = [{
                ...
                "description": "Chrysanthemum flower",
                "is_primary": true
            },
